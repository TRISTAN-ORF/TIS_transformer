...
class TranscriptSeqRiboEmbCustom(pl.LightningModule):
    ...
    def pad_edges(self, y_mask):
        # Mask labels of edges in order to exclude it from training/evaluation
...
tis_tr = TranscriptSeqRiboEmbCustom(True, False, 8, 0.001, 0.96, 1500, 30000, dim, depth, heads, dim_head, False, 80, 1000, True,
